...
export function EmptyState({ onCreate, title, desciption }: EmptyStateProps) {
  return (
    <div className="text-center py-16">
      <div className="mx-auto w-24 h-24 bg-blue-100 rounded-full flex items-center justify-center mb-6">
        <Users className="w-12 h-12 text-blue-600" />
      </div>
      <h3 className="text-2xl font-bold text-gray-900 mb-2">No {title} yet</h3>
      ...
      >
        ...
        <span>Create Your First {title}</span>
      </button>
    </div>
  );
}